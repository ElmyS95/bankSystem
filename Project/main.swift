...
var lastCustomerNum = preference.customerNum

let directoryURL = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask)[0]
let fileURL = URL(fileURLWithPath: "CustomerData", relativeTo: directoryURL).appendingPathExtension("txt")
    ...
    do {
        ...
        if String(data: savedData, encoding: .utf8) != nil {
            ...
            for line in lines {
                ...
                if let num = Int(fields[0]) {
                    if num != nil {
                        let cust = Customer(no: Int(fields[0])!, name: fields[1], address: fields[2], gender: fields[3], phone: fields[4], email: fields[5], dob: fields[6])
